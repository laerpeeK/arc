...
class ChannelA extends Component {
    ...
    changeChannel = () => {
        this.props.history.replace('/system/channel/channelB')
    }
    ...
    render() {
        return (
            <div>
                <h4>
                    <button className='netBtn' onClick={this.changeChannel}>B</button>通道</h4><br/><br/>
